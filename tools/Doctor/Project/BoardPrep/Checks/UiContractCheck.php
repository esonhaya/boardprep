...
final class UiContractCheck implements CheckInterface
{
    public function run(): CheckResult
    {
        ...
        $analysis = UiContract::analyze($root, [
            ...
            'stylesheets' => ['public/assets/css/style.css'],
            'max_preview_limit' => 5,
        ]);
        ...
        $details = [];
        foreach (['ui.legacy.presentational_table','ui.table.mobile_risk','ui.heading.wrap_risk','ui.collection.preview_too_large','ui.missing.view_all','ui.action.emoji','ui.form.unlabelled'] as $id) {
