...
final class Autoloader
{
    ...
    private static array $legacyMap = [
        ...
        'AdaptiveTopicNormalizer' => __DIR__ . '/../Services/Quiz/Adaptive/AdaptiveTopicNormalizer.php',
        'AdaptiveWeaknessTopicResolver' => __DIR__ . '/../Services/Quiz/Adaptive/AdaptiveWeaknessTopicResolver.php',
        'AdaptiveQuestionPartitioner' => __DIR__ . '/../Services/Quiz/Adaptive/AdaptiveQuestionPartitioner.php',
        'AdaptiveQuestionOrderer' => __DIR__ . '/../Services/Quiz/Adaptive/AdaptiveQuestionOrderer.php',
        'AdaptivePriorityBuilder' => __DIR__ . '/../Services/Quiz/Adaptive/AdaptivePriorityBuilder.php',
