...
final class Autoloader
{
    ...
    private static array $legacyMap = [
        ...
        'QuestionImportParser' => __DIR__ . '/../Services/Shared/QuestionImportParser.php',
        'QuestionImportProcessor' => __DIR__ . '/../Services/Shared/QuestionImportProcessor.php',
        'QuestionImportReport' => __DIR__ . '/../Services/Shared/QuestionImportReport.php',
        'QuestionValidationService' => __DIR__ . '/../Services/Shared/QuestionValidationService.php',
        'QuestionAuditService' => __DIR__ . '/../Services/Shared/QuestionAuditService.php',
        'DuplicateQuestionSummaryService' => __DIR__ . '/../Services/Shared/DuplicateQuestionSummaryService.php',
        'TaxonomyStatisticsService' => __DIR__ . '/../Services/Shared/TaxonomyStatisticsService.php',
        'QuestionQualitySummaryService' => __DIR__ . '/../Services/Shared/QuestionQualitySummaryService.php',
        'CoverageSummaryService' => __DIR__ . '/../Services/Shared/CoverageSummaryService.php',
        'MetadataRepairService' => __DIR__ . '/../Services/Shared/MetadataRepairService.php',
