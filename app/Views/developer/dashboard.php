...
<section aria-labelledby="repository-summary-heading"><div class="section-heading"><h2 id="repository-summary-heading">Content snapshot</h2><span class="badge badge-info">Measured from repository</span></div><div class="ui-metric-grid"><article class="card stat-card"><span class="stat-label">Active</span><strong class="stat-value"><?= (int)($repositorySummary['active']??0) ?></strong></article><article class="card stat-card"><span class="stat-label">Draft</span><strong class="stat-value"><?= (int)($repositorySummary['draft']??0) ?></strong></article><article class="card stat-card"><span class="stat-label">Archived</span><strong class="stat-value"><?= (int)($repositorySummary['archived']??0) ?></strong></article><article class="card stat-card"><span class="stat-label">Complete taxonomy</span><strong class="stat-value"><?= (int)($repositorySummary['taxonomyComplete']??0) ?></strong></article></div></section>
<?php $letCoverage = is_array($letCoverage ?? null) ? $letCoverage : []; ?>
<section aria-labelledby="let-coverage-heading"><div class="section-heading"><div><p class="eyebrow">LET planning view</p><h2 id="let-coverage-heading">Coverage audit</h2></div><span class="badge badge-info">Inventory only</span></div><div class="ui-metric-grid"><article class="card stat-card"><span class="stat-label">LET eligible</span><strong class="stat-value"><?= (int)($letCoverage['total']??0) ?></strong></article><article class="card stat-card"><span class="stat-label">General Education</span><strong class="stat-value"><?= (int)($letCoverage['general_education']??0) ?></strong></article><article class="card stat-card"><span class="stat-label">Professional Education</span><strong class="stat-value"><?= (int)($letCoverage['professional_education']??0) ?></strong></article><article class="card stat-card"><span class="stat-label">LET study materials</span><strong class="stat-value"><?= (int)($letCoverage['study_materials']??0) ?></strong></article></div><div class="record-list"><?php foreach (($letCoverage['areas']??[]) as $area=>$count): ?><div class="metric-row"><strong><?= htmlspecialchars((string)$area) ?></strong><span class="badge badge-info"><?= (int)$count ?> questions</span></div><?php endforeach; ?></div></section>
